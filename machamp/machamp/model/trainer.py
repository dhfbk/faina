...
def train(
    ...
    # Calculate the label distribution on the training set for class weighting, if required
    for dataset_name, dataset_obj in train_dataset.datasets.items():
        dataset_obj.set_label_distribution(dataset_configs)
